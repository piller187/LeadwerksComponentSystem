...
void main( void )
{
	...
	if (depth<1.0)
	{
		...
		vec3 vRotation=vec3(rand(gl_FragCoord.xy*gl_FragCoord.zx),rand(gl_FragCoord.zy*-gl_FragCoord.xz),rand(gl_FragCoord.xz*gl_FragCoord.yx));
		//vRotation.x = rand(gl_FragCoord.xy*gl_FragCoord.zx+cameramatrix[0].xy);
		//vRotation.y = rand(gl_FragCoord.xz*gl_FragCoord.xy+cameramatrix[0].zx);
		//vRotation.z = rand(gl_FragCoord.yz*gl_FragCoord.zx+cameramatrix[0].yz);
